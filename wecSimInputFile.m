...
simu = simulationClass();                       % Create the Simulation Variable
    ...
    simu.CITime = 15;                               % Convolution Time [s]
...
% UPDATE MASS AND MOI
    body(3).mass = 1;                               % Define mass [kg]   
    body(3).momOfInertia = [1 1 1];                 % Moment of Inertia [kg*m^2]     
...
% UPDATE MASS AND MOI
    body(4).mass = 1;                               % Define mass [kg]   
    body(4).momOfInertia = [1 1 1];                 % Moment of Inertia [kg*m^2]     
